const signUp = ()=>{
    ...
    postMethods("/clients/create", {userName:name, email:email, password: password}).then(rs => {
        if(rs.status == 200){
            // localStorage.setItem('user', JSON.stringify(rs.data));
            // showVerifyEmail()
            Notification.alert("Success!", "Đăng ký thành công", "Đăng nhập", "window.location.href='login.html'");
        }
